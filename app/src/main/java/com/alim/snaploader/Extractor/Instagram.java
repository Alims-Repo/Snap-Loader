package com.alim.snaploader.Extractor;
...
import com.alim.snaploader.Interface.VideoDownloader;
...
public class Instagram implements VideoDownloader {

    private Context context;
    private String VideoURL;
    private String VideoTitle;

    public Instagram(Context context, String videoURL) {
